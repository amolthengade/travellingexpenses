...
class Punch_In(models.Model):
    ...
    def __str__(self):
        return f'{self.date} - {self.user.username} - {self.user.first_name} {self.user.last_name}'
...
class Total_Expense(models.Model):
    ...
    def __str__(self):
        return f"{self.date} - {self.user.username}  - {self.daily_cost}"
    class Meta:
...
class Daily_Attendance(models.Model):
    ...
    def __str__(self):
        return f'{self.date} - {self.user.username} - {self.user.first_name} {self.user.last_name} - {self.present} '
